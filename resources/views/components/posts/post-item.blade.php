...
<article class="[&:not(:last-child)]:border-b border-gray-100 pb-10">
        <div class="grid items-start grid-cols-12 gap-3 mt-5 article-body">
            <div class="flex items-center col-span-4 article-thumbnail" style="width: 200px; height: 200px;">
                <a wire:navigate href="{{ route('posts.show', $post->slug) }}">
                    <img class="mx-auto w-full h-auto object-cover rounded-xl" src="{{ asset('storage/'.$post->image) }}" alt="thumbnail">
                </a>
            </div>
